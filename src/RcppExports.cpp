...
RcppExport SEXP _OrderRegression_lasso_grid(SEXP beta_gridSEXP, SEXP A_addSEXP, SEXP A_add_sizeSEXP, SEXP var_orderSEXP, SEXP grid_seqSEXP, SEXP ASEXP, SEXP A_sizeSEXP, SEXP SSEXP, SEXP S_sizeSEXP, SEXP RSEXP, SEXP R_sizeSEXP, SEXP XtySEXP, SEXP XtXSEXP, SEXP lambdaSEXP, SEXP threshSEXP, SEXP maxitSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_OrderRegression_lasso_grid_sparse", (DL_FUNC) &_OrderRegression_lasso_grid_sparse, 19},
    {"_OrderRegression_lasso_grid", (DL_FUNC) &_OrderRegression_lasso_grid, 16},
    {NULL, NULL, 0}
};

RcppExport void R_init_OrderRegression(DllInfo *dll) {
